...
public class SmartspaceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        byte[] byteArrayExtra = intent.getByteArrayExtra("com.rmathur.jelly.extra.SMARTSPACE_CARD");
        if (byteArrayExtra != null) {
            com.rmathur.jelly.smartspace.nano.SmartspaceProto.a a = new com.rmathur.jelly.smartspace.nano.SmartspaceProto.a();
            try {
